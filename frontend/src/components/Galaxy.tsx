          ...
          <div className='flex items-center gap-4'>
            ...
            <div>
              ...
              <p className='text-cyan-200'>
                Navigate to distant planets and mine resources
              </p>
            </div>
          </div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6'>
          {planets.map((planet, index) => (
            ...
            >
              {/* Planet Icon */}
              <div
                className={`w-16 h-16 bg-gradient-to-br ${planet.color} rounded-full flex items-center justify-center mx-auto mb-4`}
              >
        ...
        >
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-gray-300'>
            <div>
              ...
              <p>
                Collect resources to upgrade your starship and increase your
                combat power.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <p>
                Battle other commanders to gain experience and valuable loot.
              </p>
            </div>
          </div>
        </motion.div>
