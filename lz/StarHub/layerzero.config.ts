...
const ethHubContract: OmniPointHardhat = {
    eid: EndpointId.SEPOLIA_V2_TESTNET,
    contractName: 'StarHub',
}
...
const pathways: TwoWayConfig[] = [
    [
        ethHubContract, // Chain A contract
...
export default async function () {
    ...
    return {
        contracts: [{ contract: ethHubContract }, { contract: arbitrumContract }, { contract: baseContract }],
        connections,
    }
}
